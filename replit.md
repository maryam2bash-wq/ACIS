  ...
  acis-desktop/         ← واجهة المستخدم React
    src/
      ...
      pages/
        ...
        export-hub.tsx  ← مركز التصدير — تحميل ملفات المشاريع (نص + وسائط)
...
- **مركز التصدير**: تحميل ملفات المشاريع (نص + وسائط) من صفحة `/export-hub`
...
- **CAEOS routes**: `/api/caeos/score` و `/api/caeos/layers` تعملان بشكل كامل — تجاهل ملاحظات "قيد التطوير" القديمة.
